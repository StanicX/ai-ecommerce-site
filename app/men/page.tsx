    ...
    <main>
      <div className="bg-[#ffd200]/90 text-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold text-center">Men's Collection</h1>
        </div>
      </div>
          ...
          <div className="md:w-1/4 pr-8 mb-6 md:mb-0">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <ul className="space-y-2">
                <li className="text-[#ffd200] font-medium">All Men's</li>
                <li className="hover:text-[#ffd200] dark:text-gray-300 dark:hover:text-[#ffd200] cursor-pointer">Shirts</li>
                <li className="hover:text-[#ffd200] dark:text-gray-300 dark:hover:text-[#ffd200] cursor-pointer">Pants</li>
                <li className="hover:text-[#ffd200] dark:text-gray-300 dark:hover:text-[#ffd200] cursor-pointer">Outerwear</li>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button className="border border-gray-300 dark:border-gray-600 rounded px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-200">XXL</button>
                </div>
              </div>
